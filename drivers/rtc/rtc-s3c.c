...
static irqreturn_t s3c_rtc_alarmirq(int irq, void *id)
{
	...
	rtc_update_irq(rdev, 1, RTC_AF | RTC_IRQF);  //rtc  硬件中断到这里，上半部，里面启动了一个work
...
static int s3c_rtc_gettime(struct device *dev, struct rtc_time *rtc_tm)
{
 ...
 retry_get_time:
	...
	/*如果到达0秒就检查一下，因为年月日时分可能会有加1操作，比如此时是一年的最后天的最后一分一秒，
	//则年月日时分秒都会改变*/  
...
v /*根据RTCALM寄存器的报警全局使能位来设置报警状态结构rtc_wkalrm*/ 
...
/*
打开唤醒中断开关，RTC能在睡眠情况下唤醒系统，这只是一个开关，
真正能不能唤醒系统，需要把中断设置为唤醒中断。
*/
