...
#define S5P_VA_AUDSS		S3C_ADDR(0X01200000)// 0xFE200000
#define S5P_VA_CHIPID		S3C_ADDR(0x01300000)// 0xFE300000
#define S5P_VA_CMU		S3C_ADDR(0x01400000)// 0xFE400000
#define S5P_VA_PMU		S3C_ADDR(0x01480000)// 0xFE480000
#define S5P_VA_GPIO		S3C_ADDR(0x01500000)   // 0xFE500000
#define S5P_VA_GPIO1		S5P_VA_GPIO
#define S5P_VA_GPIO2		S3C_ADDR(0x01540000)// 0xFE540000
